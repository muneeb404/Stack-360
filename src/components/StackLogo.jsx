...
//         <img className='grayscale hover:grayscale-0 transition-all duration-300 ease-in-out mobile:max-lgmobile:w-[4rem] mobile:max-tablet:grayscale-0' src={img} alt="" />
//     </div>
//   )
// }
