...
function HeroLogo() {
  return (
    <div className="w-full relative h-[92px] my-8 bg-white flex items-center">
      ...
      <div className="px-20 z-10 w-full flex justify-between">
        ...
        >
          <img className="w-[30px] h-[30px] hover:" src={heroLogo1} alt="" />
        </div>
        <div className="p-4 w-fit rounded-full"
          ...
          <img className="w-[30px] h-[30px] hover:" src={heroLogo2} alt="" />
        </div>
        <div className="p-4 w-fit rounded-full"
          style={{
            background:
          ...
          <img className="w-[30px] h-[30px] hover:" src={heroLogo3} alt="" />
        </div>
        <div className="p-4 w-fit rounded-full"
          style={{
            background:
          ...
          <img className="w-[30px] h-[30px] hover:" src={heroLogo4} alt="" />
        </div>
        <div className="p-4 w-fit rounded-full"
          style={{
            background:
          ...
          <img className="w-[30px] h-[30px] hover:" src={heroLogo5} alt="" />
        </div>
        <div className="p-4 w-fit rounded-full"
          style={{
            background:
